...
export default function AddCategory() {
      ...
      render: (id, { name, image }) => (
        <div style={{ display: "flex", alignItems: "center" }}>
          ...
          <button
            ...
            onClick={() => deleteConfirmation(id, deleteCategory)}
          >
  ...
  return (
    <>
      ...
      <Filtr
        data={CategoryData}
        filtrated={setCategoryData}
        nameOfSession={"categoryData"}
      />

      <div className="mt-3">
        {Array.isArray(CategoryData) && (
          <Table
            pagination={CategoryData?.length > 5 ? { pageSize: 5 } : false}
