...
export default function AddSpecification() {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            paneling_id: Yup.string()
                .required("يرجي ادخال اسم منتج"),
            model_id: Yup.string()
                .required("يرجي ادخال موديل"),
            brand_id: Yup.string()
                .required("يرجي ادخال براند"),
            car_chairs: Yup.string()
                .required("يرجي ادخال عدد المقاعد"),
            price: Yup.string()
                .required("يرجي ادخال السعر"),
            is_connect: Yup.string()
                .required("يرجي ادخال هل منفصل ولا متصل ")
        }),
    ...
    return (
        <>
                ...
                <div className="container-fluid dir-ar mainFont">
                    <div className="col-xs-11 text-center row align-items-lg-center">
                        ...
                        <div className='mt-2 col-xs-12 col-sm-2 col-md-2 col-lg-3 mt-2'>
                            ...
                            >
                                <option value="" disabled selected>اختر عدد الكراسي </option>
                        ...
                        <div className='mt-2 col-xs-12 col-sm-2 col-md-2 col-lg-3 mt-2'>
                            ...
                            >
                                <option value="" disabled selected  >متصل او منفصل  </option>
            ...
            <EditSpecification i={obj} typeOf={"specifications"} idModal={"editSpecify"} fetchSpecify={fetchSpecify} nameOfImage={"image"} />
        </>
    );
}
