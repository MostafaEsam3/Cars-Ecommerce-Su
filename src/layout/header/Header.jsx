    ...
    <>
      ...
      <header className="container -warning py-1">
        <div className="row justify-content-between align-items-center">
          {/* LEFT SIDE - Avatar */}
          <div className="col-12 col-md-1 d-flex justify-content-start align-items-center">
            {isLoggedIn && (
              <img
          ...
          {/* LOGO - Exclusive */}
          <div className="-info col-12 col-md-2 text-center py-2">
            <span>Exclusive</span>
          </div>
          ...
          {/* RIGHT SIDE - Search, Cart, Buttons */}
