    ...
    const formik = useFormik({
        ...
        onSubmit: (values, { resetForm }) => {
            ...
            if (inputUser.image_end_year) {
                updatedValues.image_end_year = inputUser.image_end_year; 
            }   
            if (inputUser.image_start_year) {
                updatedValues.image_start_year = inputUser.image_start_year; 
            }     
            console.log(updatedValues);
            
            editModels(updatedValues)
        }
                ...
                <div className="modal-dialog modal-dialog-centered ">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">هل تريد تأكيد الحذف</h5>
                    ...
                    <div className='text-text-center '>
                        <button type='submit' className='btn btn-danger  text-center mt-3' data-bs-dismiss="modal">تعديل</button>
                    </div>
                </div>   
                            </form>
                        </div>
