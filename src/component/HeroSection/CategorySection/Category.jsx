      ...
      <div className="wraber_category row g-0 justify-content-start  flex-wrap dir-ar mt-3 ">
        {Data?.length > 0
          ? Data?.map((ele) => {
              return (
                <div
                  className="category d-flex flex-column align-items-center justify-content- p-4 col-6 col-md-2 mx-md-1 mt-1 mt-md-0  rounded-1 shadow"
                  style={{
                ...
                >
                  <div className="" style={{ height: "100%" }}>
                    <img
                      ...
                      className=" w-100"
                      height={"100%"}
                      onClick={() => handleFilterAccCategory(ele.id)}
                    />
                  </div>
                  <div className="mt-2">
