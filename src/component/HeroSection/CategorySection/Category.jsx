...
const Category = () => {
    return (
        <>
            ...
            <div className='wraber_category row g-0 justify-content-between  flex-wrap dir-ar mt-3' >

                <div className='category d-flex flex-column align-items-center justify-content- p-4 col-6 col-md-2 mx-md-1 mt-1 mt-md-0  rounded-1 shadow'  style={{ border: "1px solid #dbdfe9", height: "30vh" }}>
                    <div className='' style={{ height: "100%" }}>
                        <img src="https://www.bleco.sa/wp-content/uploads/2024/07/Talbesa_03-8.webp" alt="mobilePhone" className=' w-100' height={"100%"} />
                    </div>
                    <div className='mt-2'>
